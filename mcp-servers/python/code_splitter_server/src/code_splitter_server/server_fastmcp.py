...
async def split_code(
    ...
    language: str = Field("python", pattern="^python$", description="Programming language (currently only Python)"),
    split_level: str = Field("function", pattern="^(function|class|method|import|all)$",
                            description="What to extract: function, class, method, import, or all"),
    include_metadata: bool = Field(True, description="Include detailed metadata about code segments"),

...
class LaTeXProcessor:
    ...
    def compile_document(self, file_path: str, output_format: str = "pdf",
                        output_dir: Optional[str] = None, clean_aux: bool = True) -> Dict[str, Any]:
    ...
    def _find_log_file(self, output_dir: Path, base_name: str) -> Optional[str]:
    ...
    def add_table(self, file_path: str, data: List[List[str]], headers: Optional[List[str]] = None,
                 caption: Optional[str] = None, label: Optional[str] = None) -> Dict[str, Any]:
    ...
    def add_figure(self, file_path: str, image_path: str, caption: Optional[str] = None,
                  label: Optional[str] = None, width: Optional[str] = None) -> Dict[str, Any]:
    ...
    def analyze_document(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis["has_bibliography"] = bool(re.search(r'\\bibliography\{', content) or
...
async def create_document(
    ...
    document_class: str = Field("article", pattern="^(article|report|book|letter|beamer)$",
                               description="LaTeX document class"),
    title: Optional[str] = Field(None, description="Document title"),
    author: Optional[str] = Field(None, description="Document author"),
    packages: Optional[List[str]] = Field(None, description="LaTeX packages to include"),
) -> Dict[str, Any]:
...
async def compile_document(
    ...
    output_format: str = Field("pdf", pattern="^(pdf|dvi|ps)$",
...
async def add_content(
    ...
    position: str = Field("end", pattern="^(end|beginning|after_begin)$",
...
async def add_section(
    ...
    level: str = Field("section", pattern="^(section|subsection|subsubsection|chapter|part)$",
...
async def add_table(
    ...
    label: Optional[str] = Field(None, description="Table label for referencing"),
) -> Dict[str, Any]:
...
async def add_figure(
    ...
    width: Optional[str] = Field(None, description="Figure width (e.g., '0.5\\\\textwidth')"),
) -> Dict[str, Any]:
...
async def create_from_template(
    template_type: str = Field(..., pattern="^(article|letter|beamer|report|book)$",
...
def main():
    ...
    logger.info("Starting LaTeX FastMCP Server...")
    mcp.run()
